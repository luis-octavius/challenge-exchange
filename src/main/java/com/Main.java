...
public static void main(String[] args) throws IOException, InterruptedException {
        ...
        do {
                ...
                try {
                    ...
                    System.out.println("A conversão do valor " + amount + " " + requestExchange.base_code() +
                            " para " + requestExchange.target_code() + " é igual a: " + requestExchange.target_code() +
                            " " + requestExchange.conversion_result() + "\n\n");
                } catch (IOException e) {
